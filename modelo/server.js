...
class Server {
    ...
    this.app.get('/saludo', function (req, res) {
            ...
            this.app.get('/libro/:id', async function (req, res) {
                const id = req.params.id;
            ...
            this.app.get('/libro', async function (req, res) {
                let libros = await Libro.find();
                    res.json(
                    libros
                )
              })
            this.app.post('/libro',function (req, res) {
                const body = req.body;
              ...
              //put-libros
              this.app.put('/libro/:id',async function (req, res) {
                const body = req.body;
                const id = req.params.id;
              ...
              this.app.delete('/libro/:id', async function (req, res) {
                const id = req.params.id;
